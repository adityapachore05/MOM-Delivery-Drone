...
int16_t manual_acc_pitch_cal_value = -205;
int16_t manual_acc_roll_cal_value = -128;
...
int16_t manual_gyro_pitch_cal_value = 67;
int16_t manual_gyro_roll_cal_value = 28;
int16_t manual_gyro_yaw_cal_value = -20;
